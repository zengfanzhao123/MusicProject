                ...
                const lyt = setInterval(() =>{
                    ...
                    if(this.lyricObj) {
                        ...
                        for(let i in data){
                            ...
                            if(this.currentTime == i &&  this.$refs[i][0].innerText!==''){
                                if(document.querySelector('.action'))document.querySelector('.action').classList.remove('action')
                                this.$refs[i][0].className = 'action'
                                console.log(this.$refs[i][0].offsetTop,document.querySelector('.ofly').scrollTop)
